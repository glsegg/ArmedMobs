...
/**
 * The elite villager (README 5y): a gunner <b>villager</b> of the
 * <b>elite</b> voice, with 40 health and a rolled armor class.
 *
 ...
 * name, the village faction and the villager sounds - i.e. the "村民" half of "优质村民".</p>
 *
 ...
 *       {@code elite} pool family, so it never speaks another faction's lines.</li>
 * </ul>
 *
 * <p>Accuracy: elite (0.90) (see {@link FactionTierProfile}).</p>
 */
public class EliteVillagerEntity extends GunnerVillagerEntity {
    public EliteVillagerEntity(EntityType<? extends EliteVillagerEntity> type, Level level) {
        super(type, level);
    }
