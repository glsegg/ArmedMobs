...
/**
 * The elite pillager (README 5y): a gunner pillager of the
 ...
 */
public class ElitePillagerEntity extends GunnerPillagerEntity {
    public ElitePillagerEntity(EntityType<? extends ElitePillagerEntity> type, Level level) {
        super(type, level);
    }
